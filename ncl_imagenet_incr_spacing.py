...
if __name__ == "__main__":
    ...
    parser.add_argument('--warmup_model_dir', type=str, default='./data/experiments/ncl_imagenet_spacing/resnet_imagenet_base_B.pth')
    parser.add_argument('--topk', default=5, type=int)
    parser.add_argument('--model_name', type=str, default='resnet_imagenet_incr_spacing')
