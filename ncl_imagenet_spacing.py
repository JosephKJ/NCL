...
if __name__ == "__main__":
    ...
    if args.fast_dataloader:
        ...
        mix_train_loader = ImageNetLoader882_pre(args.batch_size, num_workers=num_workers, path=args.dataset_root, aug='twice_pre', shuffle=True, subfolder='train')
        ...
        mix_train_loader = ImageNetLoader882(args.batch_size, num_workers=num_workers, path=args.dataset_root, aug='twice_pre', shuffle=True, subfolder='train')
